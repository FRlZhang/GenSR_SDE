...
- Planning coverage-only validation of the reusable `P2_one_per_family` hook before widening drift beam/top-k or changing production defaults.
...
9. Prefer coverage-only validation of the reusable `P2_one_per_family` hook before widening drift beam/top-k.
