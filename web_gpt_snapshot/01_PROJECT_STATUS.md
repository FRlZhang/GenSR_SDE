...
- Planning a helper-only or small-smoke candidate-normalization diagnostic for constant-chain folding before widening drift beam/top-k.
...
9. Prefer candidate normalization / constant-chain folding diagnostics before widening drift beam/top-k.
