...
- Deciding the next residual/segment diagnostic for the 7 P2 oracle score misses. Do not treat the P2 coverage result as selected-rerank evidence or a production default change.
...
10. Use `p2_admitted_candidate_semantic_scoring.json` for a targeted residual/segment diagnostic of the 7 P2 oracle score misses. Do not run formal eval or change defaults from P2 coverage/readiness alone.
