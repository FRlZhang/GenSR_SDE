...
- Deciding the next diagnostic after the explicit `--normalized-drift-admission p2_one_per_family` runtime smoke passed. Do not treat this coverage-only result as selected-rerank evidence or a production default change.
