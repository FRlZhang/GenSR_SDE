...
- Planning one small coverage-only normalized drift-only admission diagnostic before widening drift beam/top-k or changing production defaults.
...
9. Prefer one small coverage-only normalized drift-only admission diagnostic before widening drift beam/top-k.
