...
- Interpreting the all-32 fixed residual calibration smoke. It found useful diagnostic rescues, but every non-V0 fixed variant harms at least one V0 hit; V11 shared-constant regresses. Do not treat this as selected-rerank evidence for implementation, formal eval, or a production default change.
...
10. Do not implement shared-constant or fixed residual calibration from the all-32 smoke. V4 improves sidecar selected exact/relaxed to 9/32 but harms 2 V0 hits; V11 regresses to 4/32. Treat these as scorer diagnostics only.
...
- P2 residual-calibration counterfactuals are diagnostic-only. The all-32 smoke shows V4 can improve sidecar selected exact/relaxed to 9/32, but all non-V0 variants harm V0 hits and V11 regresses, so this is not enough to add a rerank mode or production default.
