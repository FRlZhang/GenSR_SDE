...
- Planning a future optional coverage-only candidate-coverage pipeline flag for the validated reusable `P2_one_per_family` hook. Do not treat this as selected-rerank evidence or a production default change.
...
9. Prefer a small coverage-only integration flag for the validated reusable `P2_one_per_family` hook before widening drift beam/top-k.
