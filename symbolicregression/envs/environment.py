...
logger.info("Logger is now working!")
...
class EnvDataset(Dataset):
    def __init__(
        ...
        **args,
        ...
        if "input_dimension" in args:
            self.fixed_input_dimension = args["input_dimension"]
        else:
            self.fixed_input_dimension = None
